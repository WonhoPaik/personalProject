		...
		<div class="view-container">
			...
			<form>
				<table class="view-table">
					...
					<tr>
						<td class="view-label">작성자</td>
						<td class="view-value"><%=article.getWriter()%></td>
						<td class="view-label">작성일</td>
						<td class="view-value"><%=sdf.format(article.getRegdate())%></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="4" class="button-group"><input type="button"
							value="답변달기"
