...
<body onload="call_js()">
	<header>
		...
		<ul class="member">
			...
			if (loginID == null) {
			%>
			<li class="member"><a href="../registerPage.jsp" class="dropbtn">회원가입</a></li>
			<li class="member"><a href="../loginPage.jsp" class="dropbtn">로그인</a></li>
			<%
			} else if (loginID.equals("admin")) {
			%>
    ...
    <div class="container">
        <div class="board-header">
            ...
            <a href="writeForm.jsp" class="btn-write">글쓰기</a>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="subject">
                                ...
                                %>
                                <span class="reply-mark"><img src="images/re.gif" alt="답변"></span>
                                <% } %>
