		...
		<div class="delete-container">
			<center>
				...
				<form method="POST" name="delForm"
					...
					<table class="delete-table" border="1" align="center"
						cellspacing="0" cellpadding="0" width="360">
						<tr height="30">
							<td align="center" bgcolor="#444" colspan="2"><b>비밀번호를
									입력해 주세요.</b></td>
						</tr>
						<tr height="30">
							<td align="center" width="30%">비밀번호 :</td>
							<td align="left" width="70%"><input type="password"
								name="pass" size="8" maxlength="12"></td>
						</tr>
						<tr height="30">
							<td align="center" bgcolor="#444" colspan="2"><input
								type="submit" value="글 삭제"> <input type="button"
								value="글 목록"
